...
import com.compscieddy.writeaday2.model.User;
...
import static com.compscieddy.writeaday2.Analytics.AUTHENTICATION_BUTTON;
import static com.compscieddy.writeaday2.PreferenceConstants.FIRST_LOGIN_MILLIS;
...
public class AuthenticationActivity extends AppCompatActivity {
  ...
  private void saveFirstTimeLoginMillis() {
    long firstLoginMillis = Writeaday2Application.getSharedPreferencesLong(FIRST_LOGIN_MILLIS);
    if (firstLoginMillis == -1L) {
      Writeaday2Application.setSharedPreferencesLong(
          FIRST_LOGIN_MILLIS,
