...
import com.compscieddy.writeaday2.databinding.DayFragmentBinding;
import com.compscieddy.writeaday2.entry.EntryManager;
import com.compscieddy.writeaday2.eventbus.TopPaddingForDayOfWeekWithBackgroundEvent;
import com.compscieddy.writeaday2.god.DayOfWeekManager;
import com.compscieddy.writeaday2.model.Entry;
import com.compscieddy.writeaday2.photo.PhotoRequestHelper;
import com.compscieddy.writeaday2.util.AuthenticationUtil;
import com.compscieddy.writeaday2.util.DateUtil;
...
public class DayFragment extends Fragment {
  ...
  private void attachListeners() {
    binding.newTextEntryButton.setOnClickListener(v -> {
      ...
      Writeaday2Application.setSharedPreferencesString(
