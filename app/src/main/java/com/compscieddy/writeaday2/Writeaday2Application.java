...
public class Writeaday2Application extends Application {

  public static Writeaday2Application sApplicationContext;

  public static SharedPreferences getSharedPreferences() {
    return sApplicationContext.getSharedPreferences("writeaday2", Context.MODE_PRIVATE);
  }
  ...
  public void onCreate() {
    ...
    sApplicationContext = Writeaday2Application.this;
