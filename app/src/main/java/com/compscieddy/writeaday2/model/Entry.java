package com.compscieddy.writeaday2.model;
...
import com.compscieddy.writeaday2.util.FirestoreUtil;
...
import static com.compscieddy.writeaday2.model.User.USER_COLLECTION;
  ...
  public void deleteOnFirebaseStorage() {
    getPhotoStorageReference().delete()
        .addOnSuccessListener(new OnSuccessListener<Void>() {
          ...
          public void onSuccess(Void aVoid) {
            Etil.showToast(
                Writeaday2Application.sApplicationContext,
