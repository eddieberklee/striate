...
public class StriateApplication extends Application {

  public static StriateApplication sApplicationContext;

  public static SharedPreferences getSharedPreferences() {
    return sApplicationContext.getSharedPreferences("striate", Context.MODE_PRIVATE);
  }
  ...
  public void onCreate() {
    ...
    sApplicationContext = StriateApplication.this;
