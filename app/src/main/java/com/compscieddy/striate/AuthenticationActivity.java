...
import com.compscieddy.striate.model.User;
...
import static com.compscieddy.striate.Analytics.AUTHENTICATION_BUTTON;
import static com.compscieddy.striate.PreferenceConstants.FIRST_LOGIN_MILLIS;
...
public class AuthenticationActivity extends AppCompatActivity {
  ...
  private void saveFirstTimeLoginMillis() {
    long firstLoginMillis = StriateApplication.getSharedPreferencesLong(FIRST_LOGIN_MILLIS);
    if (firstLoginMillis == -1L) {
      StriateApplication.setSharedPreferencesLong(
          FIRST_LOGIN_MILLIS,
