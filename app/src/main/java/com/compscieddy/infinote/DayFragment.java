...
import com.compscieddy.infinote.databinding.DayFragmentBinding;
import com.compscieddy.infinote.entry.EntryManager;
import com.compscieddy.infinote.eventbus.TopPaddingForDayOfWeekWithBackgroundEvent;
import com.compscieddy.infinote.god.DayOfWeekManager;
import com.compscieddy.infinote.model.Entry;
import com.compscieddy.infinote.photo.PhotoRequestHelper;
...
public class DayFragment extends Fragment {
  ...
  private void attachListeners() {
    binding.newTextEntryButton.setOnClickListener(v -> {
      ...
      InfinoteApplication.setSharedPreferencesString(
