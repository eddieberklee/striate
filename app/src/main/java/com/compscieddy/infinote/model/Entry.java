package com.compscieddy.infinote.model;
...
import com.compscieddy.infinote.util.FirestoreUtil;
...
import static com.compscieddy.infinote.model.User.USER_COLLECTION;
  ...
  public void deleteOnFirebaseStorage() {
    getPhotoStorageReference().delete()
        .addOnSuccessListener(new OnSuccessListener<Void>() {
          ...
          public void onSuccess(Void aVoid) {
            Etil.showToast(
                InfinoteApplication.sApplicationContext,
